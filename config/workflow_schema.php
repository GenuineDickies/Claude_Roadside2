<?php
/**
 * RoadRunner Workflow Document Chain — Database Schema
 * 
 * Tables: estimates, work_orders, change_orders, invoices_v2, receipts,
 *         document_line_items, document_attachments, document_audit_log,
 *         work_order_progress_log, payment_transactions, rate_schedules
 * 
 * Depends on: customers, customer_vehicles, technicians, users,
 *             service_categories, service_types (from service-tickets.php)
 * 
...
function bootstrap_workflow_schema(PDO $pdo): void {
    ...
    $tables = [
        ...
        // ─── Invoices v2 (workflow chain) ────────────────────────
        // Named invoices_v2 to avoid conflict with existing invoices table
        ...
        // ─── Document Line Items (polymorphic) ───────────────────
