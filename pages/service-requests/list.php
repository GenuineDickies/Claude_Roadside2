                            ...
                            <tr class="searchable-row priority-<?php echo $req['priority']; ?>">
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="?page=service-requests&action=view&id=<?php echo $req['id']; ?>" class="btn btn-outline-primary">View</a>
                                        <?php if (in_array($req['status'], ['created', 'dispatched', 'acknowledged', 'en_route', 'on_scene', 'in_progress'])): ?>
                                            <a href="?page=estimates&action=create&sr_id=<?php echo $req['id']; ?>" class="btn btn-outline-info" title="Create Estimate">Estimate</a>
                                        <?php endif; ?>
                                        <?php if ($req['status'] === 'completed'): ?>
                                            <a href="?page=invoices&action=create&request_id=<?php echo $req['id']; ?>" class="btn btn-outline-success">Invoice</a>
                                        <?php endif; ?>
                                    </div>
                                </td>
                            </tr>
